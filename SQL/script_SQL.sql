...
INSERT INTO `edu_db`.`note` (`note_id`, `title`, `time`, `tags`, `user_user_id`, `ref`) VALUES (4, 'Biologia', '2019-03-30 05:10:24.086000', 'matematyka, macierze', 1, '6789');
INSERT INTO `edu_db`.`note` (`note_id`, `title`, `time`, `tags`, `user_user_id`, `ref`) VALUES (5, 'Chemia', '2019-03-29 05:26:19.086000', 'historia, kraj', 2, '5678');
INSERT INTO `edu_db`.`note` (`note_id`, `title`, `time`, `tags`, `user_user_id`, `ref`) VALUES (6, 'Wzory z Chemii ', '2019-03-29 05:35:19.826000', 'fizyka, fale elektromagnetyczne', 1, '4567');
INSERT INTO `edu_db`.`note` (`note_id`, `title`, `time`, `tags`, `user_user_id`, `ref`) VALUES (7, 'Plastyka', '2019-03-30 05:10:24.086000', 'matematyka, macierze', 1, '3456');
INSERT INTO `edu_db`.`note` (`note_id`, `title`, `time`, `tags`, `user_user_id`, `ref`) VALUES (8, 'Informatyka', '2019-03-29 05:26:19.086000', 'historia, kraj', 2, '2345');
INSERT INTO `edu_db`.`note` (`note_id`, `title`, `time`, `tags`, `user_user_id`, `ref`) VALUES (9, 'Wzory z Chemii', '2019-03-29 05:35:19.826000', 'fizyka, fale elektromagnetyczne', 1, '1234');
